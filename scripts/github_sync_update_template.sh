...
COMMIT_MSG="v1.5：增加文献摘要/全文/PDF多层兜底与卡片右上角en/zh切换"
...
grep -q 'version = "1.5.0"' "$SRC_DIR/pyproject.toml" || { echo "错误：不是 v1.5.0 工程包。"; exit 1; }

echo "v1.5 工程目录：$SRC_DIR"
echo "本地仓库目录：$OLD_DIR"
